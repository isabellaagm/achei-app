      ...
      {!guests.length ? (
        ...
        <Card className="mb-3 overflow-x-auto p-3">
          <table className="w-full text-[13px]">
            <thead>
              <tr className="border-b border-border text-left font-body text-[10px] font-medium uppercase tracking-wide text-ink/45">
                ...
                <tr key={g.id} className="border-b border-border/60">
                  ...
                  <td className="px-2 py-2">
                    <button
                      ...
                      className="rounded-full border border-border px-3 py-1.5 font-body text-xs hover:border-azul hover:text-azul"
                    >
                      WhatsApp
                    </button>
                  </td>
